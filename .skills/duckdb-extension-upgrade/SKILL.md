...
description: Upgrade the latency_injection_fs extension to a new DuckDB release. Use when the user asks to upgrade DuckDB, bump the duckdb submodule, sync to a new DuckDB tag (e.g. v1.5.2), or update the duckdb / duckdb-httpfs / extension-ci-tools submodules together.
---

# Upgrade latency_injection_fs to a new DuckDB release
...
- 6. Run test
  + Extension C++ unit test: `./build/reldebug/extension/latency_injection_fs/test/unittest/unittest_latency_injection`
